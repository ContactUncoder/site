...
```
/*
 * Code for an Arduino music box, combined into one file so that no libraries have to be used.
 * 
 * Split into three sections: 
 * (1) Music box code.
 * ------------------------
 * (2) Constant values representing notes.
 * (3) Fur elise code.
 * 
 * 
 * For the Uncoder Youtube Channel.
 */
...
/*************************************************
 * Fur Elise. Code by Robson Couto. (github.com/robsoncouto/arduino-songs)
 *************************************************/
